...
public class DatabaseInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        var professorsalved = professorRepository.save(professor);

        var course1 = new Course(new CourseDTO(1L,"GAT102","Introdução à Engenharia de Controle e Automação",1, List.of(professorsalved)));
        var course2 = new Course(new CourseDTO(2L,"GFI103","Conceitos de Física A",1, List.of(professorsalved)));
